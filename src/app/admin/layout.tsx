...
function AdminSidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-50 h-full w-64 bg-primary-950 text-white transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:z-auto ${
      ...
      >
        <div className="flex items-center gap-3 px-6 py-5 border-b border-primary-800">
          ...
          <div>
            <h2 className="font-semibold text-sm">SMA Annajah</h2>
        ...
        <nav className="p-4 space-y-6 overflow-y-auto h-[calc(100vh-73px)]">
          {menuItems.map((section) => (
            <div key={section.section}>
              <p className="text-xs font-semibold text-primary-300 uppercase tracking-wider mb-2 px-3">
                {section.section}
              </p>
