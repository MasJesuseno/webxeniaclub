                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-3 text-xs text-gray-400">
                      ...
                      {contact.phone && (
                        <a
                          href={`https://wa.me/${contact.phone.replace(/^0/, "62").replace(/[^0-9]/g, "")}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1.5 rounded-full bg-green-50 px-2.5 py-1 text-green-700 font-medium hover:bg-green-100 active:scale-95 transition-all"
